...
client String,
server String,
cipher_alg Enum8(''=0, 'arcfour'=1, 'aes256-ctr'=2, 'arcfour256'=3, 'aes128-ctr'=4, 'chacha20-poly1305@openssh.com'=5, 'aes128-cbc'=6, '3des-cbc'=7, 'Algorithm negotiation failed'=8,'aes128-gcm@openssh.com'=9,'aes256-cbc'=10,'arcfour128'=11,'aes256-gcm@openssh.com'=12,'blowfish-cbc'=13,'aes192-ctr'=14),
